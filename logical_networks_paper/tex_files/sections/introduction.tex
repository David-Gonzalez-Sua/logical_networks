...
% G: "designed to solve NP..." Needs a citation. Many such exist for either
%    Clingo or ASP in general.
Conversely, Answer Set Programming (ASP) languages live at a different end of the research spectrum in terms of their efficiency. They are designed to solve NP-Complete and NP-Hard problems in a fast and efficient manner on limited hardware. Our current work involves exploring the use of ASP languages to accelerate the processes of learning and inference. The eventual goal of our research is to reduce the resources needed for these technologies.
